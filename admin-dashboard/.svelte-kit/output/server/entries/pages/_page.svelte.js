...
const css$7 = {
  code: ".liquid-nav.svelte-kdoo8f.svelte-kdoo8f{position:fixed;top:0;left:0;right:0;z-index:1000;height:80px;transition:all var(--glass-transition-fluid);will-change:transform, backdrop-filter}.nav-backdrop.svelte-kdoo8f.svelte-kdoo8f{position:absolute;inset:0;height:200%;background:linear-gradient(\n      to bottom,\n      rgba(10, 10, 15, var(--nav-opacity)) 0%,\n      rgba(10, 10, 15, 0.4) 50%,\n      transparent 100%\n    );backdrop-filter:var(--glass-blur-primary) saturate(180%);mask-image:linear-gradient(\n      to bottom,\n      black 0% 50%,\n      transparent 50% 100%\n    );pointer-events:none}.nav-edge.svelte-kdoo8f.svelte-kdoo8f{position:absolute;bottom:0;left:0;right:0;height:1px;background:var(--glass-border-light);backdrop-filter:blur(8px) brightness(120%)}.scrolled.svelte-kdoo8f .nav-backdrop.svelte-kdoo8f{backdrop-filter:var(--glass-blur-primary) saturate(200%) brightness(110%)}",
  map: `{"version":3,"file":"LiquidNavigation.svelte","sources":["LiquidNavigation.svelte"],"sourcesContent":["<script lang=\\"ts\\">import { page } from '$app/stores';\\nimport { onMount } from 'svelte';\\nlet scrollY = 0;\\nlet navElement;\\n$: isScrolled = scrollY > 20;\\n$: navOpacity = Math.min(0.95, 0.7 + (scrollY / 200) * 0.25);\\n<\/script>\\n\\n<svelte:window bind:scrollY />\\n\\n<nav \\n  bind:this={navElement}\\n  class=\\"liquid-nav\\" \\n  class:scrolled={isScrolled}\\n  style=\\"--nav-opacity: {navOpacity}\\"\\n>\\n  <div class=\\"nav-backdrop\\"></div>\\n  <div class=\\"nav-content\\">\\n    <div class=\\"nav-brand\\">\\n      <h1>MCP Analytics</h1>\\n    </div>\\n    <div class=\\"nav-links\\">\\n      <!-- Navigation items -->\\n    </div>\\n  </div>\\n  <div class=\\"nav-edge\\"></div>\\n</nav>\\n\\n<style>\\n  .liquid-nav {\\n    position: fixed;\\n    top: 0;\\n    left: 0;\\n    right: 0;\\n    z-index: 1000;\\n    height: 80px;\\n    transition: all var(--glass-transition-fluid);\\n    will-change: transform, backdrop-filter;\\n  }\\n  \\n  .nav-backdrop {\\n    position: absolute;\\n    inset: 0;\\n    height: 200%;\\n    background: linear-gradient(\\n      to bottom,\\n      rgba(10, 10, 15, var(--nav-opacity)) 0%,\\n      rgba(10, 10, 15, 0.4) 50%,\\n      transparent 100%\\n    );\\n    backdrop-filter: var(--glass-blur-primary) saturate(180%);\\n    mask-image: linear-gradient(\\n      to bottom,\\n      black 0% 50%,\\n      transparent 50% 100%\\n    );\\n    pointer-events: none;\\n  }\\n  \\n  .nav-edge {\\n    position: absolute;\\n    bottom: 0;\\n    left: 0;\\n    right: 0;\\n    height: 1px;\\n    background: var(--glass-border-light);\\n    backdrop-filter: blur(8px) brightness(120%);\\n  }\\n  \\n  .scrolled .nav-backdrop {\\n    backdrop-filter: var(--glass-blur-primary) saturate(200%) brightness(110%);\\n  }\\n</style>\\n"],"names":[],"mappings":"AA6BE,uCAAY,CACV,QAAQ,CAAE,KAAK,CACf,GAAG,CAAE,CAAC,CACN,IAAI,CAAE,CAAC,CACP,KAAK,CAAE,CAAC,CACR,OAAO,CAAE,IAAI,CACb,MAAM,CAAE,IAAI,CACZ,UAAU,CAAE,GAAG,CAAC,IAAI,wBAAwB,CAAC,CAC7C,WAAW,CAAE,SAAS,CAAC,CAAC,eAC1B,CAEA,yCAAc,CACZ,QAAQ,CAAE,QAAQ,CAClB,KAAK,CAAE,CAAC,CACR,MAAM,CAAE,IAAI,CACZ,UAAU,CAAE;AAChB,MAAM,EAAE,CAAC,MAAM;AACf,MAAM,KAAK,EAAE,CAAC,CAAC,EAAE,CAAC,CAAC,EAAE,CAAC,CAAC,IAAI,aAAa,CAAC,CAAC,CAAC,EAAE;AAC7C,MAAM,KAAK,EAAE,CAAC,CAAC,EAAE,CAAC,CAAC,EAAE,CAAC,CAAC,GAAG,CAAC,CAAC,GAAG;AAC/B,MAAM,WAAW,CAAC;AAClB,KAAK,CACD,eAAe,CAAE,IAAI,oBAAoB,CAAC,CAAC,SAAS,IAAI,CAAC,CACzD,UAAU,CAAE;AAChB,MAAM,EAAE,CAAC,MAAM;AACf,MAAM,KAAK,CAAC,EAAE,CAAC,GAAG;AAClB,MAAM,WAAW,CAAC,GAAG,CAAC;AACtB,KAAK,CACD,cAAc,CAAE,IAClB,CAEA,qCAAU,CACR,QAAQ,CAAE,QAAQ,CAClB,MAAM,CAAE,CAAC,CACT,IAAI,CAAE,CAAC,CACP,KAAK,CAAE,CAAC,CACR,MAAM,CAAE,GAAG,CACX,UAAU,CAAE,IAAI,oBAAoB,CAAC,CACrC,eAAe,CAAE,KAAK,GAAG,CAAC,CAAC,WAAW,IAAI,CAC5C,CAEA,uBAAS,CAAC,2BAAc,CACtB,eAAe,CAAE,IAAI,oBAAoB,CAAC,CAAC,SAAS,IAAI,CAAC,CAAC,WAAW,IAAI,CAC3E"}`
};
const LiquidNavigation = create_ssr_component(($$result, $$props, $$bindings, slots) => {
  ...
  isScrolled = scrollY > 20;
  navOpacity = Math.min(0.95, 0.7 + scrollY / 200 * 0.25);
  return ` <nav class="${["liquid-nav svelte-kdoo8f", isScrolled ? "scrolled" : ""].join(" ").trim()}" style="${"--nav-opacity: " + escape(navOpacity, true)}"${add_attribute()}><div class="nav-backdrop svelte-kdoo8f"></div> <div class="nav-content" data-svelte-h="svelte-s8832s"><div class="nav-brand"><h1>MCP Analytics</h1></div> <div class="nav-links"></div></div> <div class="nav-edge svelte-kdoo8f"></div> </nav>`;
});
const css$6 = {
...
const GlassChart = create_ssr_component(($$result, $$props, $$bindings, slots) => {
  ...
  return `<div class="glass-chart-container svelte-1uo6ke6" style="${"height: " + escape(height, true) + "px"}"><canvas${add_attribute()}></canvas> </div>`;
});
const css$4 = {
